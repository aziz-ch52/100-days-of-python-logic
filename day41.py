...
# Step 3: Calculate the expected sum of numbers from 1 to N using the formula for the sum of an arithmetic series
expected_sum = N * (N + 1) // 2

# Step 4: Calculate the actual sum of the numbers in the list
actual_sum = sum(numbers)

# Step 5: The missing number is the difference between the expected and actual sum
